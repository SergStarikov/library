...
<%@page import="com.starikoff.myLibrary.model.Category"%>
<%
...
<div class="leftbar">
	...
	<form class="search">
		<input type="hidden" name="action" value="search" /> <input bookId="text"
			type="text" name="keyWord" size="12" /> <span
			class="tooltip_message">?</span>
		<p />
		<input bookId="submit" type="submit" value="Search" />
	</form>
